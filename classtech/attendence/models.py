...
types = [('None', 'None'), ('cvr', 'cvr'), ('asr', 'asr'),
         ('vvk', 'vvk'), ('vsr', 'vsr'), ('sac', 'sac'), ('dvr', 'dvr')]
...
class Profile(models.Model):
    ...
    hostelname = models.CharField(
        choices=types, max_length=20, null=True, blank=False, default='employee')
    hosteltype = models.CharField(
        choices=H_types, max_length=20, null=True, blank=False, default='non_ac')
